...
Game.Cosmos.PLANET_TYPE_ARTEFACTS = {
	jungle: {
		// white
		weapon_parts: 100, silver_plasmoid: 80, ship_details: 60,
		meteor_fragments: 40, crystal_fragments: 20,
		// green
		secret_technology: 100, rotary_amplifier: 80, reptile_technology: 60,
		emerald_plasmoid: 40, batteries: 20,
		// blue
		sapphire_plasmoid: 100, quad_cooler: 80, plasma_transistors: 60,
		nanowires: 40, chip: 20,
		// purple
		nicolascagium: 100, keanureevesium: 80, jimcarrium: 60,
		garyoldmanium: 40, amethyst_plasmoid: 20,
		// orange
		topaz_plasmoid: 100, ancient_technology: 80, ancient_scheme: 60,
		ancient_knowledge: 40, ancient_artefact: 20,
		// red
		ruby_plasmoid: 100
	},
	terran: {
...
Game.Cosmos.ARTEFACTS_GROUP_SPREAD = [
	[
		{ group: 'white',  chance: 100, power: 1 }
	],
	[
		{ group: 'green',  chance: 100, power: 1 }
	],
	[
		{ group: 'green',  chance: 75, power: 1 },
		{ group: 'blue',   chance: 25, power: 0.5 }
	],
	[
		{ group: 'blue',   chance: 100, power: 1 }
	],
	[
		{ group: 'blue',   chance: 75, power: 1 },
		{ group: 'purple', chance: 25, power: 0.5 }
	],
	[
		{ group: 'purple', chance: 100, power: 1 }
	],
	[
		{ group: 'purple', chance: 75, power: 1 },
		{ group: 'orange', chance: 25, power: 0.5 }
	],
	[
		{ group: 'orange', chance: 100, power: 1 }
	],
	[
		{ group: 'orange', chance: 75, power: 1 },
		{ group: 'red',    chance: 25, power: 0.5 }
	],
	[
		{ group: 'orange', chance: 50, power: 1 },
		{ group: 'red',    chance: 50, power: 1 }
	]
];
