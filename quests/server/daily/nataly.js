...
new game.DailyQuest({
	...
	answers: { 
		...
		callFicksics: {
			...
			win: 'Если Вы имели ввиду ремонтную бригаду, Консул, то они уже на месте и почти закончили предварительные проверки. Кажется, мы сможем восстановить установку без особых затрат.',
			fail: 'Если Вы имели ввиду ремонтную бригаду, Консул, то её я вызвала в первую очередь. К сожалению, установка окончательно вышла из строя и восстановлению не подлежит.'
		}
	}
});
