...
new game.DailyQuest({
	...
	answers: {
		chop: {
			...
			win: 'Не думайте Консул, что я сомневалась в вас хоть секундочку, но как бы это ни было странно... ваш план сработал, огонь шёл по земле, но не смог пройти там где не было деревьев, наверное именно деревья ка кто подпитывали этот огонь при этом оставаясь нетронутыми, здорово, Правитель. Вы снова всех спасли!',
		...
		sciencebitch: {
			...
			win: 'Умный ход, мой Император. Наши учёные выяснили как действует этот огонь, это вовсе и не огонь, как оказалось, это энергетическое сгорание некого особого газа на этой планете, который вырабатывают корни деревьев. Мы легко смогли определить катализатор и избавиться от него, пожар прекратился. Прекрасно, Консул.',
...
new game.DailyQuest({
	...
	who: 'tamily',
	name: 'Элемент',
	text: 'Правитель, тут какая то странная рыжая девушка пытается попасть на ваше планету. Она что-то там рассказывает про какое то зло, про стихии и говорит, что у неё мультипаспорт, что делать?',
	answers: {
		pyramids: {
...
new game.DailyQuest({
	...
	answers: {
		...
		show: {
			text: 'Устроим мего-концерт со всеми звёздами в поддержку Людской расы.',
			...
			fail: 'Шоу выдалось отличным, Консул. Но это только разогрело людей и начались волнения в городе. Мы смогли со всем разобраться, кого надо посадили, остальные на время забыли о своём недовольстве. Но в любом случае, это ещё не конец.'
		},
		martin: {
			text: 'Нужен отвлекающий манёвр, чтобы все забыли о своих проблемах. Новый сериал с еблей и кровищем! Звоните Мартину.',
			win: 'Превосходная идея, Правитель. Мартин работает в поте лица, я так же взяла на себя смелость и подключила к сценарию Коронелу, не беспокойтесь, его дилер тоже у нас. Всё идёт как по маслу, новые серии выходят каждую неделю, люди сидят как зомби у своих гало-экранов и даже не думают выходить из дома. Всё супер!',
			fail: 'Идея была отличной, Консул. Вот только Мартин устроил там некую заварушку на свадьбе.. я имею ввиду в самом сериале. Я точно не в курсе, но кажется именно это привело к новым волнениям в колонии. Эх... ни дня покоя.'
		}
	}
});
...
new game.DailyQuest({
	...
	answers: {
		fathers: {
			...
			fail: 'Мы сделали всё как вы приказали, правитель, однако с метра падения капсулы уже несколько часов мы не получаем никаких сигналов.',
		...
		blowup: {
			...
			win: 'Как же я сама не догадалась, пару литром жидкого кристалла решили проблему моментально, и как всегда благодаря вашему прекрасному плану.'
		},
		sendback: {
			text: 'Как можно быстрее отправьте обратно в космос, эта штука слишком опасная.',
			fail: 'Нашим инженерам удалось отправить эту шкатулку пандоры в открытый космос, к несчастью траектория полёта совпала с траекторией торгового судна, хоть и повреждения не были критическими экипаж корабля не отвечает, слышен только скрежет металла.',
			win: 'Нам удалось пристроить пусковые двигатели к капсуле, после чего она была успешно отправлена туда, откуда прибыла, надеюсь оно больше к нам никогда не вернется.'
		},
	}
});
