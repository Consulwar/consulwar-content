...
new game.QuestLine({
	...
	new game.Quest({
		...
		text: '<p>Представляете, Командир, наши горе-политиканы решили заказать в Лаборатоии исследование, что критика публичных лиц подрывает внутренние устои общества. И даже список приложили. Три дня заседали без перерыва на обед, всё вспоминали, как их в колонии обычно называют.<p></p>Конец немного предсказуем: Натали увидела, что хотят протолкнуть через её драгоценную Лабораторию, пришла в ярость, обозвала пиджаков всеми теми словами, которые они хотели запретить, и прикрыла «перспективное» направление.</p>',
