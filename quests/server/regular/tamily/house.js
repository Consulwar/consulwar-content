...
new game.QuestLine({
	...
	new game.Quest({
		...
		options: {
			accept: {
				text: 'Бля, я уже сам хочу там жить.',
				mood: 'positive'
			}
		},
		isDone: function() {
