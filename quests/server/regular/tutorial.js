...
new game.QuestLine({
	...
	new game.Quest({
		...
		isDone: function() {
			return 
			Game.Research.has('evolution', 'alloy', 5) && Game.Research.has('evolution', 'ikea', 5)
		}
	}), new game.Quest({
		...
		isDone: function() {
			return
			Game.Building.has('residential', 'metal', 10) && Game.Building.has('residential', 'crystal', 10)
		}
	}), new game.Quest({
