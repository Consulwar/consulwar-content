	...
	effect: [new Game.Effect.Special({
		...
		result: function(level) {
			...
			if (level < 50) {
				...
				return 'эффект на 50-м уровне усиления';
			} else {
			return 'эффект на 100-м уровне усиления';
			}
	}})],
	basePrice: {
		humans: 10,
...
new game.Unit({
	...
	// Нелинейный крейсер - (30 урон, 70 броня) умножает на 2 полученные за усиления статы (1-100 ур). Спецспособность: 50% шанс на 4-ой атаке нанести 100% урон
	engName: 'cruiser',
...
new game.Unit({
	...
	// Гексакор - (50 урон, 140 броня) умножает на 2 полученные за усиления статы (1-100 ур). Спецспособность: 20% шанс в каждой атаке получить на 80% меньше урона
	engName: 'battleship',
...
new game.Unit({
	...
	// Проект Х - (80 урон, 180 броня) умножает на 2 полученные за усиления статы (1-100 ур). Спецспособность: восстанавливает 30% Ос после боя
	engName: 'carrier',
...
new game.Unit({
	...
	// Плазменный дредноут - (200 урон, 400 броня) умножает на 2 полученные за усиления статы (1-100 ур). Спецспособность: на 2-ой и 3-ей атаке наносит 100% урон первой цели
	engName: 'dreadnought',
...
new game.Unit({
	...
	// Артиллерийский рейлган - (500 урон, 200 броня) умножает на 2 полученные за усиления статы (1-100 ур). Спецспособность: 80% шанс нанести 300% урона Тени в первой атаке
	engName: 'railgun',
...
new game.Unit({
	...
	// Мифический пожинатель - (600 урон, 1200 броня) умножает на 2 полученные за усиления статы (1-100 ур). Спецспособность: после уничтожения наносит 1 000 000 урона вражескому флоту
	engName: 'reaper',
