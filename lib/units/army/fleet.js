...
new game.Unit({
	name: 'Гаммадрон',
	// Бетадрон - (1 урон, 2 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: принимает на себя 30% урона первой атаки   
	// Альфадрон - (2 урон, 3 броня) умножает на 2 полученные за усиления статы (1-100 ур). Спецспособность: принимает на себя 50% урона первой атаки 
	engName: 'gammadrone',
...
new game.Unit({
	name: 'Оса',
	// Королевская Оса - (2 урон, 3 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: 1% шанс уничтожить Дракон перед своей смертью 
	// Шершень - (4 урон, 5 броня) умножает на 2 полученные за усиления статы (1-100 ур). Спецспособность: 2% шанс уничтожить Дракон перед своей смертью 
	engName: 'wasp',
...
new game.Unit({
	name: 'Мираж',
	// Призрак - (3 урон, 5 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: 30% шанс не получить урон во время первой атаки
	// Фантом - (6 урон, 10 броня) умножает на 2 полученные за усиления статы (1-100 ур). Спецспособность: 50% шанс не получить урон во время первой атаки
	engName: 'mirage',
...
new game.Unit({
	name: 'Фрегат',
	// Фрегат поддержки - (8 урон, 20 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: на 15% больше урона по Клинкам
	// Боевой фрегат - (6 урон, 10 броня) умножает на 2 полученные за усиления статы (1-100 ур). Спецспособность: на 35% больше урона по Клинкам
	engName: 'frigate',
...
new game.Unit({
	name: 'Трак C',
	// Трак B - (+100 ресов за уровень) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: 40% шанс вообще не получить урон
	// Трак A - (+200 ресов за уровень) умножает на 2 полученные за усиления статы (1-100 ур). Спецспособность: 80% шанс вообще не получить урон
	engName: 'truckc',
...
new game.Unit({
	name: 'Крейсер',
	// Линейный крейсер - (15 урон, 35 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: 20% шанс на 4-ой атаке нанести 100% урон
	// Нелинейный крейсер - (30 урон, 70 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: 50% шанс на 4-ой атаке нанести 100% урон
	engName: 'cruiser',
	...
	requirements: function() {
		return [
			...
			[Game.Building.items.evolution.science, 25]
		]
	}
});
...
new game.Unit({
	name: 'Линкор',
	// Квадракор - (25 урон, 70 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: 10% шанс в каждой атаке получить на 40% меньше урона
	// Гексакор - (50 урон, 140 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: 20% шанс в каждой атаке получить на 80% меньше урона
	engName: 'battleship',
	...
	requirements: function() {
		return [
			...
			[Game.Building.items.evolution.alloy,     40],
...
new game.Unit({
	name: 'Авианосец',
	// Боевая база - (40 урон, 90 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: восстанавливает 15% Ос после боя
	// Проект Х - (80 урон, 180 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: восстанавливает 30% Ос после боя
	engName: 'carrier',
	...
	requirements: function() {
		return [
			...
			[Game.Building.items.evolution.alloy,      45],
...
new game.Unit({
	name: 'Дредноут',
	// Лучевой дредноут - (100 урон, 200 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: на 2-ой атаке наносит 100% урон первой цели
	// Плазменный дредноут - (200 урон, 400 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: на 2-ой и 3-ей атаке наносит 100% урон первой цели
	engName: 'dreadnought',
	...
	requirements: function() {
		return [
			...
			[Game.Building.items.evolution.alloy,      50],
...
new game.Unit({
	name: 'Рейлган',
	// Снайперский рейлган - (250 урон, 100 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: 40% шанс нанести 300% урона Тени в первой атаке
	// Артиллерийский рейлган - (500 урон, 200 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: 80% шанс нанести 300% урона Тени в первой атаке
	engName: 'railgun',
	...
	requirements: function() {
		return [
			...
			[Game.Building.items.evolution.energy,     60],
...
new game.Unit({
	name: 'Пожинатель',
	// Древний пожинатель - (300 урон, 600 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: после уничтожения наносит 500 000 урона вражескому флоту
	// Мифический пожинатель - (600 урон, 1200 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: после уничтожения наносит 1 000 000 урона вражескому флоту
	engName: 'reaper',
	...
	requirements: function() {
		return [
			...
			[Game.Research.items.military.void,     60]
		]
	}
});
new game.Unit({
	...
	// Императорский флагман - (1500 урон, 5000 броня) умножает на 2 полученные за усиления статы (1-50 ур). Спецспособность: 100% шанс вернуться домой несмотря на исход боя
	engName: 'flagship',
