...
new game.Unit({
	...
	engName: 'gammadrone',
	description: 'Гаммадроны это шустрые беспилотные убийцы. Их задача ловить на себя часть урона, уничтожать небольшой и шустрые корабли Рептилоидов. Конечно имея целый рой таких аппаратов можно навалять даже самому крупному кораблю, однако, наверное это всё же не лучшая тактика. Хотя кто знает, Консул. Всё зависит только от вас. Тем не менее гаммадроны дешёвые и крайне полезные единицы.',
...
new game.Unit({
	...
	engName: 'mirage',
	description: 'В рамках разработки новых технологий защиты от Рептилий, был разработан новый аппарат, на основе системе стелс атмосферных истребителей. Мираж отражает большинство сигналов и практически невидим на радарах противника. Однако же всё это не позволяет кораблю быть полностью неуловимым, лишь усложняет наведение по нему, тем не менее этого достаточно, чтобы он выполнял свою задачу. Полезных действий мираж выполняет больше, хотя по урону и броне соответствует Осе.',
...
new game.Unit({
	...
	engName: 'frigate',
	description: 'Фрегаты это корабли лёгкого класса. Достаточно небольшой сам по себе, Фрегат однако же обладает неплохим вооружением и бронёй, а так же скоростью стрельбы. Способен уничтожать небольшие корабли противника. Часто используется как небольшие передвижные оборонные корабли. Идти впереди всех на урон Фрегат не сможет, зато прикрывать крупные союзные корабли от истребителей Рептилоидов он вполне способен и отлично справляется с этой задачей.',
...
new game.Unit({
	...
	engName: 'truckc',
	description: 'Траки не обладают серьёзным вооружением, могут сбить разве что парочку дронов. Но надо понимать, что Траки это не боевые корабли. Траки нужны для того чтобы собирать полезный лом после боя. Трюмы у боевых кораблей гораздо больше, но трак владеет особыми системами сканирования и техническими устройствами, благодаря которым он может находить среди лома уничтоженных кораблей небольшие но рабочие и полезные элементы. Так или иначе, имея Траки в своём флоте вы заработаете больше ресурсов за победу.',
...
new game.Unit({
	...
	battleEffects: [{
		...
		onBattleEnd: function(unit, friends, enemies, round, options) {
			return Game.Unit.battleEffects.restoreUnits(this.result(), unit, friends['army.fleet.wasp']);
		}
	}],
	basePrice: {
		humans: 17000,
...
new game.Unit({
	...
	engName: 'dreadnought',
	description: 'Дредноут корабль среднего краса. По размеру немного меньше авианосца. Однако же получил своё звание Дредноута благодаря особой системе строения. Фронтальная броня Дредноута практически непробиваемая. Его орудия многочисленны и крайне точны, скорость стрельбы поражает. Крупные орудия на бортах способны сносить с одного залпа небольшие корабли врага. Особая система боковых двигателей позволяет Дредноуту крайне быстро разворачиваться носом в нужную сторону. Обойти его сверху или снизу не выйдет, крупный калибр не позволит. Очень мощный корабль людей, единственная его слабость это заход врага со спины.',
...
new game.Unit({
	...
	engName: 'railgun',
	description: 'Реилганы это беспилотные небольшие, управляемые искусственным разумом, снайперские орудия. По размеру не больше обычной осы. Эти маленькие убийцы настоящий прорыв ювелирных технологий людей. Особые плазменные призмы преобразуют энергию кристаллов в особое вещество, которое со скоростью света вырывается в нужном направлении и на огромном расстоянии буквально разрезает корабли врага пополам, как нож в тёплое масло. Реилганы не обладают серьёзной бронёй, из защита - это то, что они находятся далеко от поля боя, к сожалению они практически беззащитны в ближнем бою.',
...
new game.Unit({
	...
	engName: 'reaper',
	description: 'Для получения технологии данного корабля наши учёные годами изучали данные полученные через портал из другой вселенной. К сожалению пока что мы смогли понять не больше 10% из общего количества систем кораблей класса Пожиратель. Так или иначе на основе этих знаний мы смогли построить нечто похожее на оригинал и этого было достаточно, чтобы собрать самый мощный корабль массового производства среди флота человеческой расы. Его броня превосходна, а урон сложно недооценить. Сотни таких чудовищ разнесут практически любой флот противника.',
