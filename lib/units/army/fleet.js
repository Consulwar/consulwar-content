...
new game.Unit({
	...
	battleEffects: [{
		...
		onRoundEnd: function(unit, friends, enemies, round, options) {
			return Game.Unit.battleEffects.destroyAfterDeath(this.result(), unit, enemies['reptiles.fleet.dragon']);
		}
	}],
	basePrice: {
		humans: 10,
...
new game.Unit({
	...
	battleEffects: [{
		...
		onAttack: function(unit, friends, enemies, round, options) {
			return Game.Unit.battleEffects.moreDamage(this.result(), unit, enemies['reptiles.fleet.blade']);
		}
	}],
	basePrice: {
		humans: 100,
...
new game.Unit({
	...
	battleEffects: [{
		...
		onRoundStart: function(unit, friends, enemies, round, options) {
			...
			return Game.Unit.battleEffects.maximizeDamage(this.result(), unit);
		}
	}],
	basePrice: {
		humans: 1500,
	...
	battleEffects: [{
		...
		onAttack: function(unit, friends, enemies, round, options) {
			...
			if (level < 50) {
				...
				return Game.Unit.battleEffects.reduceDamage(10, 40, unit);
			} else {
				return Game.Unit.battleEffects.reduceDamage(20, 80, unit);
			}
		}
	}],
	basePrice: {
...
new game.Unit({
	...
	battleEffects: [{
		...
		onRoundEnd: function(unit, friends, enemies, round, options) {
			return Game.Unit.battleEffects.applyDamage(this.result(), unit, enemies);
		}
	}],
	basePrice: {
		humans: 100000,
...
new game.Unit({
	...
	battleEffects: [{
		...
		onBattleEnd: function(unit, friends, enemies, round, options) {
			return Game.Unit.battleEffects.ressurectUnits(this.result(), unit);
		}
	}],
	basePrice: {
		humans: 150000,
