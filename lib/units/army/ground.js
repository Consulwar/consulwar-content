...
new game.Unit({
	name: 'Танк Мамка 2.0',
	engName: 'mothertank',
	description: 'Мамка 2.0. Это продвинутая версия оригинальной Мамки, была изобретена специально для войны с Рептилоидами. Конечно же, этот танк далеко не такой огромный, как твоя мамка, и всё же его размеры впечатляют. Правда, если в прошлой версии лишь башня была размером с двухэтажный дом, то теперь весь танк такого размера. Это помогло увеличить мобильность, а новая лучевая пушка сохранила мощность Мамки. Теперь она может даже совершать попытки маневрирования на поле боя. Правда, двигается она всё ещё медленно. Зато нагибает… Она просто медленно двигается к цели и нагибает… Двигается… и нагибает.',
	basePrice: {
		humans: 300,
		metals: 400000,
		crystals: 100000,
...
new game.Unit({
	name: 'Бабочка',
	engName: 'relax',
	description: 'Порхай как бабочка и жаль как… Ай! Сука бля! Бабочка – это единственный корабль такого размера, который может передвигаться в воздушном пространстве и в почти любой атмосфере. Да, он не очень быстрый, но чёрт подери, это же грёбаная летающая крепость! Бабочка не просто уничтожает, она уничтожает всех… Вообще всех. Всё – больше нет рептилий, на земле одни трупы, в небе чисто, техника уничтожена. Вы что, не верите? Постройте пару десятков бабочек, и вы узнаете о чём я говорю, Консул.',
	basePrice: {
		humans: 10000,
		metals: 1500000,
		crystals: 540000,
