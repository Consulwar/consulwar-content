...
new game.Unit({
	name: 'Бабочка',
	engName: 'relax',
	description: 'Порхай как бабочка и жаль как.. а сука бля! Бабочка это единственный корабль такого размера, который может передвигаться в воздушной пространстве и в почти любой атмосфере. Да, он не очень быстрый, но чёрт подери, это же грёбаная летающая крепость! Бабочка не просто уничтожает, оно уничтожает всех вообще всех. Всё, больше нет рептилий, на земле одни трупы, в небе чисто, техника уничтожена. Вы что, не верите? Постройте пару десяток бабочек и узнаете о чём я говорю, Консул. ',
	basePrice: {
		humans: 10000,
		metals: 1500000,
		crystals: 540000,
