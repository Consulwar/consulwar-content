...
new game.ReptileUnit({
	name: 'Сферо',
	// Спецспособность: наносит 100% урон приоритетным целям
	engName: 'sphero',
...
new game.ReptileUnit({
	name: 'Клинок',
	// Спецспособность: 20% шанс не получить урон во время первой атаки
	engName: 'blade',
...
new game.ReptileUnit({
	name: 'Ящер',
	// Спецспособность: 5% шанс уничтожить Мираж с 1 выстрела
	engName: 'lacertian',
...
new game.ReptileUnit({
	name: 'Виверна',
	// Спецспособность: на 10% больше урона наносит приоритетным целям (второе орудие)
	engName: 'wyvern',
...
new game.ReptileUnit({
	name: 'Трионикс',
	// Спецспособность: получает на 50% меньше урона от Гаммадрона
	engName: 'trioniks',
...
new game.ReptileUnit({
	name: 'Дракон',
	// Спецспособность: после смерти наносит 20% своего урона рандомной цели
	engName: 'dragon',
...
new game.ReptileUnit({
	name: 'Хайль-Гидра',
	// Спецспособность: во время первой атаки бьет только в одну цель, но со 150% урона
	engName: 'hydra',
...
new game.ReptileUnit({
	name: 'Броненосец',
	// Спецспособность: во время первой атаки получает на 90% меньше урона
	engName: 'armadillo',
...
new game.ReptileUnit({
	name: 'Призма',
	// Спецспособность: 50% шанс нанести урон еще 2-м целям во время первой атаки, каждая цель получит по 25% от начального урона
	engName: 'prism',
...
new game.ReptileUnit({
	name: 'Спрут',
	// Спецспособность: наносит урон сразу по 3-м целям, и всем по 100% урона
	engName: 'octopus',
...
new game.ReptileUnit({
	name: 'Годзилла',
	// Спецспособность: получает на 50% меньше урона в первой атаке, на 20% - во второй, на 5% - в третьей
	engName: 'godzilla',
...
new game.ReptileUnit({
	name: 'Тень',
	// Спецспособность: 5% шанс уничтожить 1 уровень любого здания во время атаки на планету Консула
	engName: 'shadow',
