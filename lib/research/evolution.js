...
new game.Research({
	...
	engName: 'engineering',
	description: 'Злоебучие Рептилоиды повсюду, Консул. Следует держать ухо востро, а ещё лучше — заштамповаться оборонительными сооружениями. Создать из своей планеты целую непокорную крепость с сотнями… Нет… Тысячами! Орудий! Чёрт, как возбуждает. Но вы же понимаете, Консул, что оборону нужно развивать, ничего само собой с неба не падает, кроме поджареных рептилоидов… Если у вас есть планетарные пушки.',
...
new game.Research({
	...
	description: 'ОСД или, как её прозвали ребята из научного сообщества, Орудие Судного Дня — это новейшая система вооружения, требующая огромного количества энергии для использования. В тоже время испытания на одной из планет показали, на что способно ОСД. К сожалению, орудие настолько мощное, что приходится тратить кучу времени на его зарядку и калибровку. Однако же результат стоит того в полной мере.',
	effect: [new Game.Effect.Special({
		notImplemented: true,
