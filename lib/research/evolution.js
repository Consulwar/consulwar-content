...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [10, slowExpGrow, 0],
				crystals: [20, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [100, slowLinearGrow, 21];
			}
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [20, slowExpGrow, 0],
				crystals: [10, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [110, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.meteor_fragments = [4, slowLinearGrow, 41];
			} else if (level < 81) {
...
new game.Research({
	...
	basePrice: function(level) {
			...
			if (level > 20) {
				price.honor = [120, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.secret_technology = [4, slowLinearGrow, 61];
			} else {
				return price.quad_cooler = [6, slowLinearGrow, 81];
			}	
	},
	maxLevel: 100,
	requirements: function(level) {
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [35, slowExpGrow, 0],
				crystals: [10, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [130, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				return price.nanowires = [6, slowLinearGrow, 81];
			}	
	},
	maxLevel: 100,
	requirements: function(level) {
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				...
				crystals: [5, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [140, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.rotary_amplifier = [5, slowLinearGrow, 41];
			} else if (level < 81) {
...
new game.Research({
	...
	basePrice: function(level) {
			...
			if (level < 21) {
				...
				price.emerald_plasmoid = [4, slowLinearGrow, 41];
			} else if (level < 81) {
				price.sapphire_plasmoid = [6, slowLinearGrow, 61];
			} else {
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [120, slowExpGrow, 0],
				crystals: [80, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [250, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.chip = [6, slowLinearGrow, 41];
			} else if (level < 81) {
				price.keanureevesium = [4, slowLinearGrow, 61];
			} else {
				return price.ancient_technology = [3, slowLinearGrow, 81];
			}	
	},
	maxLevel: 100,
	requirements: function(level) {
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [100, slowExpGrow, 0],
				crystals: [100, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [200, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.nanowires = [6, slowLinearGrow, 41];
			} else if (level < 81) {
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [30, slowExpGrow, 0],
				crystals: [200, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [300, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.amethyst_plasmoid = [4, slowLinearGrow, 61];
			} else {
				return price.ancient_knowledge = [4, slowLinearGrow, 81];
			}	
	},
	maxLevel: 100,
	requirements: function(level) {
...
new game.Research({
	...
	basePrice: function(level) {
			...
			if (level < 21) {
				...
				return price.ancient_artefact = [3, slowLinearGrow, 81];
			}	
	},
	maxLevel: 100,
	requirements: function(level) {
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [240, slowExpGrow, 0],
				crystals: [160, slowExpGrow, 0]
			}
			...
			if (level < 21) {
				...
				price.keanureevesium = [4, slowLinearGrow, 41];
			} else if (level < 81) {
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				...
				crystals: [300, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [800, slowLinearGrow, 21];
			}
