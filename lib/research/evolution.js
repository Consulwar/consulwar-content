...
new game.Research({
	...
	requirements: function(level) {
		...
		if (level < 21) {
			return [
				[Game.Research.items.military.laboratory,   5]
			];
		} else if (level < 41) {
			return [
				[Game.Research.items.military.laboratory,  15],
				[Game.Building.items.evolution.science,    10]
			]
		} else if (level < 61) {
			return [
				[Game.Research.items.military.laboratory,    25],
				[Game.Building.items.evolution.science,      15],
				[Game.Building.items.military.powerstation,  20]
			]
		} else if (level < 81) {
			return [
				[Game.Research.items.military.laboratory,    35],
				[Game.Building.items.evolution.science,      25],
				[Game.Building.items.military.powerstation,  40]
			]
		} else {
			return [
				[Game.Research.items.military.laboratory,    45],
				[Game.Building.items.evolution.science,      45],
...
new game.Research({
	...
	requirements: function(level) {
		...
		if (level < 21) {
			return [
				[Game.Research.items.military.laboratory,  10]
			];
		} else if (level < 41) {
			return [
				[Game.Research.items.military.laboratory,  20],
				[Game.Building.items.evolution.science,    10]
			]
		} else if (level < 61) {
			return [
				[Game.Research.items.military.laboratory,  30],
				[Game.Building.items.evolution.science,    20]
			]
		} else if (level < 81) {
			return [
				[Game.Research.items.military.laboratory,  40],
				[Game.Building.items.evolution.science,    40]
			]
		} else {
			return [
				[Game.Research.items.military.laboratory,      50],
				[Game.Building.items.evolution.science,        50],
...
new game.Research({
	...
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				[Game.Research.items.military.laboratory,  55],
...
new game.Research({
	...
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				[Game.Research.items.military.laboratory, 60]
			]
		}
	}
});
...
new game.Research({
	...
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				[Game.Research.items.military.laboratory,  65],
...
new game.Research({
	...
	basePrice: {
		// 40+ изумрудный плазмоид
		// 60+ сапфировый плазмоид
		// 80+ джимкерий
		metals: 5,
		crystals: 30,
		humans: 1
	...
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				[Game.Research.items.military.laboratory,  70],
...
new game.Research({
	...
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				[Game.Research.items.military.laboratory,  45],
				[Game.Building.items.evolution.energy,     20]
			]
		} else if (level < 61) {
			return [
				[Game.Research.items.military.laboratory,  55],
				[Game.Building.items.evolution.energy,     40]
			]
		} else if (level < 81) {
			return [
				[Game.Research.items.military.laboratory,  65],
			...
			return [
				[Game.Research.items.military.laboratory,  75],
				[Game.Building.items.evolution.energy,     80]
			]
		}
	}
});
...
new game.Research({
	...
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				[Game.Research.items.military.laboratory,  80],
...
new game.Research({
	...
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				[Game.Research.items.military.laboratory,       85],
...
new game.Research({
	...
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				[Game.Research.items.military.laboratory, 60],
				[Game.Building.items.evolution.alloy,     20]
			]
		} else if (level < 61) {
			return [
				[Game.Research.items.military.laboratory, 70],
			...
			return [
				[Game.Research.items.military.laboratory, 80],
				[Game.Building.items.evolution.alloy,     60]
			]
		} else {
			return [
				[Game.Research.items.military.laboratory, 90],
				[Game.Building.items.evolution.alloy,     80]
			]
		}
	}
});
...
new game.Research({
	...
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				[Game.Research.items.military.laboratory,      95],
...
new game.Research({
	...
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				[Game.Research.items.military.laboratory,     100],
