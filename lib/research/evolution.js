...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [10, game.functions.slowGrow, 0],
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [35, game.functions.slowGrow, 0],
				crystals: [10, game.functions.slowGrow, 0]
			}
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				...
				crystals: [5, game.functions.slowGrow, 0]
			}
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [5, game.functions.slowGrow, 0],
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [120, game.functions.slowGrow, 0],
				crystals: [80, game.functions.slowGrow, 0]
			}
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				...
				crystals: [100, game.functions.slowGrow, 0]
			}
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [30, game.functions.slowGrow, 0],
				crystals: [200, game.functions.slowGrow, 0]
			}
...
new game.Research({
	...
	basePrice: function(level) {
			...
			if (level < 21) {
				...
				return price.ancient_artefact = [3, game.functions.slowLinearGrow, 81];
			}	
	},
	maxLevel: 100,
	requirements: function(level) {
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [240, game.functions.slowGrow, 0],
				crystals: [160, game.functions.slowGrow, 0]
			}
...
new game.Research({
	...
	basePrice: function(level) {
			...
			var price = {
				...
				crystals: [300, game.functions.slowGrow, 0]
			}
