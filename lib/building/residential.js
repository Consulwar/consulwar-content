...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [20, game.functions.slowGrow, 0],
			...
			if (level < 21) {
				...
				return price.quad_cooler = [6, game.functions.slowLinearGrow, 81];
			}
	},	
	maxLevel: 100,
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [100, game.functions.slowGrow, 0],
				crystals: [10, game.functions.slowGrow, 0]
			}
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [140, game.functions.slowGrow, 0],
				crystals: [75, game.functions.slowGrow, 0]
			}
			...
			if (level < 21) {
				...
				return price.nanowires = [6, game.functions.slowLinearGrow, 81];
			}
	},
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [300, game.functions.slowGrow, 0],
				crystals: [400, game.functions.slowGrow, 0]
			}
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [10000, game.functions.slowGrow, 0],
				crystals: [10000, game.functions.slowGrow, 0]
			}
			...
			if (level < 21) {
				...
				return price.ancient_technology = [3, game.functions.slowLinearGrow, 81];
			}
	},	
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [20000, game.functions.slowGrow, 0],
				crystals: [20000, game.functions.slowGrow, 0]
			}
			...
			if (level < 21) {
				...
				return price.ancient_knowledge = [4, game.functions.slowLinearGrow, 81];
			}
	},	
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [15000, game.functions.slowGrow, 0],
				crystals: [15000, game.functions.slowGrow, 0]
			}
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [5000, game.functions.slowGrow, 0],
				crystals: [2000, game.functions.slowGrow, 0]
			}
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [2000, game.functions.slowGrow, 0],
				crystals: [1500, game.functions.slowGrow, 0]
			}
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [5000, game.functions.slowGrow, 0],
				crystals: [6000, game.functions.slowGrow, 0]
			}
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [7500, game.functions.slowGrow, 0],
				crystals: [9000, game.functions.slowGrow, 0]
			}
