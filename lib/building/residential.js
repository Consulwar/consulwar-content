...
new game.Building({
	...
	requirements: function(level) {
		...
		if (level < 21) {
			return [
				[Game.Research.items.residential.colosseum, 20]
			];
		} else if (level < 41) {
			return [
				[Game.Research.items.residential.colosseum, 30],
				[Game.Building.items.evolution.animalworld, 25],
			]
		} else if (level < 61) {
			return [
				[Game.Research.items.residential.colosseum, 40],
				[Game.Building.items.evolution.animalworld, 45],
				[Game.Building.items.evolution.ikea,        50]
			]
		} else if (level < 81) {
			return [
				[Game.Research.items.residential.colosseum, 50],
				[Game.Building.items.evolution.animalworld, 65],
				[Game.Building.items.evolution.ikea,        75],
				[Game.Research.items.military.oscd,         35],
			]
		} else {
			return [
				[Game.Research.items.residential.colosseum, 75],
				[Game.Building.items.evolution.animalworld, 85],
...
new game.Building({
	...
	requirements: function(level) {
		...
		if (level < 21) {
			return [
				[Game.Research.items.residential.political, 25]
			];
		} else if (level < 41) {
			return [
				[Game.Research.items.residential.political, 35],
				[Game.Building.items.residential.spaceport, 40],
			]
		} else if (level < 61) {
			return [
				[Game.Research.items.residential.political, 50],
				[Game.Building.items.residential.spaceport, 55],
				[Game.Building.items.military.shipyard,     45]
			]
		} else if (level < 81) {
			return [
				[Game.Research.items.residential.political, 65],
			...
			return [
				[Game.Research.items.residential.political, 75],
