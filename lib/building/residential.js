...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [140, slowExpGrow, 0],
				crystals: [75, slowExpGrow, 0]
			}
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [300, slowExpGrow, 0],
				crystals: [400, slowExpGrow, 0]
			}
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [10000, slowExpGrow, 0],
				crystals: [10000, slowExpGrow, 0]
			}
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [20000, slowExpGrow, 0],
				crystals: [20000, slowExpGrow, 0]
			}
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [15000, slowExpGrow, 0],
				crystals: [15000, slowExpGrow, 0]
			}
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [5000, slowExpGrow, 0],
				crystals: [2000, slowExpGrow, 0]
			}
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [2000, slowExpGrow, 0],
				crystals: [1500, slowExpGrow, 0]
			}
			...
			if (level < 21) {
				...
				price.garyoldmanium = [5, slowLinearGrow, 61];
			} else {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [5000, slowExpGrow, 0],
				crystals: [6000, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [80, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.ancient_artefact = [3, slowLinearGrow, 61];
			} else {
				return price.ruby_plasmoid = [8, slowLinearGrow, 81];
			}
	},
	...
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				...
				[Game.Building.items.evolution.ikea,        50]
			]
		} else if (level < 81) {
			return [
			...
			return [
				...
				[Game.Building.items.evolution.ikea,       100],
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [7500, slowExpGrow, 0],
				crystals: [9000, slowExpGrow, 0]
			}
			...
			if (level < 21) {
				...
				price.chip = [6, slowLinearGrow, 21];
			} else if (level < 61) {
				price.nicolascagium = [5, slowLinearGrow, 41];
			} else if (level < 81) {
				price.ancient_artefact = [3, slowLinearGrow, 61];
			} else {
				return price.ruby_plasmoid = [8, slowLinearGrow, 81];
