...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [50, game.functions.slowGrow, 0],
				crystals: [30, game.functions.slowGrow, 0]
			}

			if (level > 20) {
				price.honor = [60, game.functions.slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.emerald_plasmoid = [4, game.functions.slowLinearGrow, 61];
			} else {
				return price.sapphire_plasmoid = [6, game.functions.slowLinearGrow, 81];
			}
	},	
	maxLevel: 100,
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [30, game.functions.slowGrow, 0],
				crystals: [10, game.functions.slowGrow, 0]
			}
			...
			if (level < 21) {
				...
				return price.plasma_transistors = [5, game.functions.slowLinearGrow, 81];
			}
	},	
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [150, game.functions.slowGrow, 0],
				crystals: [10, game.functions.slowGrow, 0]
			}
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [400, game.functions.slowGrow, 0],
				crystals: [20, game.functions.slowGrow, 0]
			}
			...
			if (level < 21) {
				...
				return price.chip = [6, game.functions.slowLinearGrow, 81];
			}	
	},
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [450, game.functions.slowGrow, 0],
				crystals: [390, game.functions.slowGrow, 0]
			}

			if (level > 20) {
				price.honor = [350, game.functions.slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				return price.keanureevesium = [4, game.functions.slowLinearGrow, 81];
			}	
	},	
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [600, game.functions.slowGrow, 0],
				crystals: [450, game.functions.slowGrow, 0]
			}
			...
			if (level < 21) {
				...
				price.batteries = [5, game.functions.slowLinearGrow, 41];
			} else if (level < 81) {
				price.nanowires = [6, game.functions.slowLinearGrow, 61];
			} else {
				return price.jimcarrium = [4, game.functions.slowLinearGrow, 81];
			}	
	},	
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [500, game.functions.slowGrow, 0],
				crystals: [500, game.functions.slowGrow, 0]
			}

			if (level > 20) {
				price.honor = [600, game.functions.slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.chip = [6, game.functions.slowLinearGrow, 61];
			} else {
				return price.amethyst_plasmoid = [4, game.functions.slowLinearGrow, 81];
			}	
	},	
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [750, game.functions.slowGrow, 0],
				crystals: [750, game.functions.slowGrow, 0]
			}
			...
			if (level < 21) {
				...
				price.reptile_technology = [4, game.functions.slowLinearGrow, 41];
			} else if (level < 81) {
				price.plasma_transistors = [5, game.functions.slowLinearGrow, 61];
			} else {
				return price.garyoldmanium = [5, game.functions.slowLinearGrow, 81];
			}	
	},
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [800, game.functions.slowGrow, 0],
				crystals: [900, game.functions.slowGrow, 0]
			}

			if (level > 20) {
				price.honor = [1200, game.functions.slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				return price.ancient_scheme = [3, game.functions.slowLinearGrow, 81];
			}	
	},
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [1000, game.functions.slowGrow, 0],
				crystals: [1000, game.functions.slowGrow, 0]
			}
			...
			if (level < 21) {
				...
				return price.ruby_plasmoid = [8, game.functions.slowLinearGrow, 81];
			}	
	},	
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			if (level < 21) {
				...
				price.ancient_technology = [3, game.functions.slowLinearGrow, 61];
			} else {
				return price.ruby_plasmoid = [8, game.functions.slowLinearGrow, 81];
			}	
	},	
...
new game.Building({
	...
	basePrice: function(level) {
			...
			if (level < 21) {
				...
				price.jimcarrium = [4, game.functions.slowLinearGrow, 41];
			} else if (level < 81) {
