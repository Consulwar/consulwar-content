...
new game.Building({
  ...
  effect: [new Game.Effect.Price({
    pretext: 'Строительство техники на ',
    aftertext: '% дешевле',
    condition: {
      type: 'unit',
      group: 'ground',
  ...
  requirements: function(level) {
    ...
    if (level < 20) {
      ...
      return [
        ...
        [Game.Building.items.military.shipyard,     60]
      ];
    }  
  }
});
...
new game.Building({
  ...
  effect: [new Game.Effect.Price({
    pretext: 'Строительство авиации на ',
    aftertext: '% дешевле',
    condition: {
      type: 'unit',
      group: 'ground',
  ...
  requirements: function(level) {
    ...
    if (level < 20) {
      ...
      return [
        ...
        [Game.Building.items.residential.alliance,  40],
        [Game.Building.items.military.shipyard,     35]
      ];
    } else {
      return [
        [Game.Building.items.military.powerstation, 65],
...
new game.Building({
  ...
  effect: [new Game.Effect.Price({
    pretext: 'Строительство флота на ',
    aftertext: '% дешевле',
    condition: {
      type: 'unit',
      group: 'fleet'
...
new game.Building({
  ...
  effect: [new Game.Effect.Price({
    pretext: 'Строительство обороны на ',
    aftertext: '% дешевле',
    condition: {
      type: 'unit',
      group: 'defense'
  ...
  requirements: function(level) {
    ...
    if (level < 20) {
      ...
      return [
        ...
        [Game.Building.items.residential.pulsecatcher, 20]
      ];
    } else if (level < 80) {
      return [
        [Game.Building.items.military.powerstation, 65],
      ...
      return [
        ...
        [Game.Building.items.residential.pulsecatcher, 60]        
      ];
    }  
  }  
});
...
new game.Building({
  ...
  effect: [new Game.Effect.Special({
    notImplemented: true,
    pretext: '+',
    aftertext: '% ресурсов за победы в космосе',
    result: function(level) {
      level = (level !== undefined ? level : this.level); 
      return level * 0.1;
    }
  ...
  requirements: function(level) {
    ...
    if (level < 20) {
      ...
      return [
        ...
        [Game.Building.items.residential.entertainment, 60]
      ];
    } else {
      return [
        ...
        [Game.Building.items.residential.entertainment, 90]
      ];
    }  
  }
});
...
new game.Building({
  ...
  effect: [new Game.Effect.Military({
    ...
    pretext: '+',
    aftertext: '% шансу способности орбитальных станций',
    result: function(level) {
      level = (level !== undefined ? level : this.level); 
      return [0, 10, 20, 40, 60, 80][Math.floor(level / 20)];
    }
  ...
  requirements: function(level) {
    ...
    if (level < 20) {
      ...
      return [
        ...
        [Game.Research.items.evolution.energy,        80],
        [Game.Building.items.residential.blackmarket, 60]
      ];
    } else {
      return [
        [Game.Building.items.military.powerstation,  100],
        ...
        [Game.Building.items.residential.blackmarket, 70]
      ];
    }  
  }
});
