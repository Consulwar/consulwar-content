...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [50, slowExpGrow, 0],
				crystals: [30, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [60, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.silver_plasmoid = [3, slowLinearGrow, 41];
			} else if (level < 81) {
				price.emerald_plasmoid = [4, slowLinearGrow, 61];
			} else {
				return price.sapphire_plasmoid = [6, slowLinearGrow, 81];
			}
	},	
	maxLevel: 100,
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [30, slowExpGrow, 0],
				crystals: [10, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [40, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.crystal_fragments = [4, slowLinearGrow, 41];
			} else if (level < 81) {
				price.batteries = [5, slowLinearGrow, 61];
			} else {
				return price.plasma_transistors = [5, slowLinearGrow, 81];
			}
	},	
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [150, slowExpGrow, 0],
				crystals: [10, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [50, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.weapon_parts = [3, slowLinearGrow, 41];
			} else if (level < 81) {
				price.reptile_technology = [4, slowLinearGrow, 61];
			} else {
				return price.sapphire_plasmoid = [6, slowLinearGrow, 81];
			}
	},	
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [400, slowExpGrow, 0],
				crystals: [20, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [150, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.ship_details = [4, slowLinearGrow, 41];
			} else if (level < 81) {
				price.rotary_amplifier = [5, slowLinearGrow, 61];
			} else {
				return price.chip = [6, slowLinearGrow, 81];
			}	
	},
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [450, slowExpGrow, 0],
				crystals: [390, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [350, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.secret_technology = [4, slowLinearGrow, 41];
			} else if (level < 81) {
				price.quad_cooler = [6, slowLinearGrow, 61];
			} else {
				return price.keanureevesium = [4, slowLinearGrow, 81];
			}	
	},	
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [600, slowExpGrow, 0],
				crystals: [450, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [500, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.batteries = [5, slowLinearGrow, 41];
			} else if (level < 81) {
				price.nanowires = [6, slowLinearGrow, 61];
			} else {
				return price.jimcarrium = [4, slowLinearGrow, 81];
			}	
	},	
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [500, slowExpGrow, 0],
				crystals: [500, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [600, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.chip = [6, slowLinearGrow, 61];
			} else {
				return price.amethyst_plasmoid = [4, slowLinearGrow, 81];
			}	
	},	
	maxLevel: 100,
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				[Game.Building.items.military.powerstation, 45],
				[Game.Building.items.evolution.engineering,  1]
			]
		} else if (level < 61) {
			return [
				[Game.Building.items.military.powerstation, 55],
			...
			return [
				[Game.Building.items.military.powerstation, 65],
				[Game.Building.items.evolution.engineering, 40],
				[Game.Building.items.military.pulsecatcher, 40]
			]
		} else {
			return [
				[Game.Building.items.military.powerstation, 80],
				[Game.Building.items.evolution.engineering, 65],
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [750, slowExpGrow, 0],
				crystals: [750, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [1000, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.reptile_technology = [4, slowLinearGrow, 41];
			} else if (level < 81) {
				price.plasma_transistors = [5, slowLinearGrow, 61];
			} else {
				return price.garyoldmanium = [5, slowLinearGrow, 81];
			}	
	},
	maxLevel: 100,
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				...
				[Game.Building.items.evolution.drill,         25]
			]
		} else if (level < 61) {
			return [
				[Game.Building.items.military.defensecomplex,   40],
				[Game.Building.items.evolution.drill,           35],
				[Game.Building.items.evolution.crystallization, 35]
			]
		} else if (level < 81) {
			return [
				[Game.Building.items.military.defensecomplex,   50],
				[Game.Building.items.evolution.drill,           45],
				[Game.Building.items.evolution.crystallization, 45],
				[Game.Research.items.evolution.engineering,     45]
			]
		} else {
			return [
				[Game.Building.items.military.defensecomplex,   60],
				[Game.Building.items.evolution.drill,           55],
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [800, slowExpGrow, 0],
				crystals: [900, slowExpGrow, 0]
			}

			if (level > 20) {
				price.honor = [1200, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.quad_cooler = [6, slowLinearGrow, 41];
			} else if (level < 81) {
				price.nicolascagium = [5, slowLinearGrow, 61];
			} else {
				return price.ancient_scheme = [3, slowLinearGrow, 81];
			}	
	},
	maxLevel: 100,
	requirements: function(level) {
		...
		if (level < 21) {
			...
			return [
				[Game.Building.items.military.powerstation,    65],
				[Game.Building.items.evolution.nanotechnology, 30]
			]
		} else if (level < 61) {
			return [
				[Game.Building.items.military.powerstation,    75],
				[Game.Building.items.evolution.nanotechnology, 45],
				[Game.Building.items.evolution.converter,       1]
			]
		} else if (level < 81) {
			return [
				[Game.Building.items.military.powerstation,    85],
				[Game.Building.items.evolution.nanotechnology, 60],
				[Game.Building.items.evolution.converter,      35]				
			]
		} else {
			return [
				[Game.Building.items.military.powerstation,    95],
				[Game.Building.items.evolution.nanotechnology, 75],
				[Game.Building.items.evolution.converter,      60]				
			]
		}	
	}
});
...
new game.Building({
	...
	basePrice: function(level) {
			...
			var price = {
				metals:   [1000, slowExpGrow, 0],
				crystals: [1000, slowExpGrow, 0]
			}
			...
			if (level < 21) {
				...
				price.sapphire_plasmoid = [6, slowLinearGrow, 21];
			} else if (level < 61) {
				price.amethyst_plasmoid = [4, slowLinearGrow, 41];
			} else if (level < 81) {
				price.topaz_plasmoid = [3, slowLinearGrow, 61];
			} else {
				return price.ruby_plasmoid = [8, slowLinearGrow, 81];
			}	
	},	
	maxLevel: 100,
	requirements: function(level) {
...
new game.Building({
	...
	basePrice: function(level) {
			...
			if (level < 21) {
				...
				price.garyoldmanium = [5, slowLinearGrow, 41];
			} else if (level < 81) {
				price.ancient_technology = [3, slowLinearGrow, 61];
			} else {
				return price.ruby_plasmoid = [8, slowLinearGrow, 81];
			}	
	},	
...
new game.Building({
	...
	basePrice: function(level) {
			...
			if (level > 20) {
				price.honor = [700, slowLinearGrow, 21];
			}
			...
			if (level < 21) {
				...
				price.jimcarrium = [4, slowLinearGrow, 41];
			} else if (level < 81) {
				price.ancient_knowledge = [4, slowLinearGrow, 61];
			} else {
				return price.ruby_plasmoid = [8, slowLinearGrow, 81];
			}	
	},	
